...
interface NotesState {
  ...
  updateNote: (id: string, data: { title?: string; content?: string; folder_id?: string | null; is_pinned?: boolean; due_at?: string | null; note_type?: string; parent_id?: string | null }) => Promise<void>;
